        ...
        >
          ...
          <div>
            ...
            <div className={"mobile:text-[5px]"}>
              ООО "ОРГНЕФТЕХИМ", 142403, Россия, Московская область, г. Ногинск,
              ул. Индустриальная, д. 41В, Э/О 2/332. Телефон: +7(915) 097-39-27,
              +7(915) 097-23-97, E-mail: orgneftekhim@gmail.com
            </div>
          </div>
        </div>
      </div>
