...
const About: NextPage<{ title: string }> = () => {
  return (
    <>
      <div className="flex flex-col my-2 py-10 px-2 tracking-wide max-h-full  items-center justify-center bg-white md:rounded-2xl md:h-auto md:gap-4 md:py-24 md:px-16 md:mx-20 max-w-7xl">
        <p className="mb-2 text-sm md:font-medium text-xl text-justify ">
        ...
        <p className="mb-2 text-sm md:font-medium text-xl text-justify indent-10">
          Мы на практике знаем, что такое бурение скважин, добыча нефти и
          газового конденсата, переработка этого сырья на нефтеперерабатывающих
          и нефтехимических заводах, хорошо понимаем логистические процессы при
        ...
        <p className="mb-2 text-sm md:font-medium text-xl text-justify indent-10">
          ...
          честность, порядочность, доверие. Если Ваши ценности совпадают с
          нашими ценностями, то Вы нашли то, что искали, так как
        </p>
