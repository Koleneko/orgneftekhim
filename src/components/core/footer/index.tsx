...
const Footer: FC = () => {
  return (
    <div>
      <div
        className={
          "text-white h-full bg-black flex items-center gap-5 p-5 flex-col text-center mobile:flex-row "
        }
      >
        ...
        <div
          className={
            "text-[5px] text-justify mobile:text-[6px] tablet:text-[12px] pl-[25%]"
          }
        >
          ООО &quot;ОРГНЕФТЕХИМ&quot;
          <br />
